<template>
    <div class="wx-header">
      ...
      <div class="header-name">
        <span>微信</span><i class="wx-msg-count">(1)</i>
      </div>
      <!-- 右侧按钮 -->
      <div class="header-other">
        ...
        <!-- 添加好友 只在通讯录页显示 -->
        <router-link tag="span" class="iconfont icon-addfriend" v-show="$route.path === '/address'" to="/address/addfriend"></router-link>
        <!-- 微信页面下拉菜单 -->
        <ul class="dropdown-menu" :class="menuStatus ? 'menu-open' : 'menu-close'">
          ...
          <li>
            <span class="iconfont icon-addfriend"></span>
            <div>添加朋友</div>
          </li>
          <li>
            <span class="iconfont icon-sys"></span>
            <div>扫一扫</div>
          </li>
          <li>
            <span class="iconfont icon-sfk"></span>
            <div>收付款</div>
          </li>
        </ul>
      </div>
